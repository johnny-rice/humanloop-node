 ...
 * @export
 * @interface GenericConfigRequest
 */
export interface GenericConfigRequest {
    /**
     * A description of the model config.
     * @type {string}
     * @memberof GenericConfigRequest
     */
    'description'?: string;
    /**
     ...
     * @memberof GenericConfigRequest
     */
    'type': GenericConfigRequestTypeEnum;
    /**
...
type GenericConfigRequestTypeEnum = 'generic'
